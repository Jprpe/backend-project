...
const URI = 'mongodb+srv://judithprpe:ondina@cluster0.evwbkct.mongodb.net/?retryWrites=true&w=majority'
...
async function start(){
    try{
        ...
        app.listen(3000, () => console.log('Servidor levantado en el 3000'));
    }catch(err){
